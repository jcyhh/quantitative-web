...
Keep canonical, reviewable team skills in `ai/skills/`. Use `AGENTS.md` for concise mandatory rules, `docs/` and ADRs for detailed durable knowledge, skills for task workflow, and lint/tests/CI for mechanically enforceable policy.
