export const zhCN = {
    ...
    dashboard: {
        greeting: '早上好，Jcy',
        subtitle: '这是你的量化投资工作台概览。',
        createStrategy: '+ 新建策略',
        equity: '策略净值',
        totalReturn: '累计收益',
        maxDrawdown: '最大回撤',
        activeStrategies: '运行中策略',
        equityChange: '今日 +1.24%',
        returnChange: '近 30 日 +3.18%',
        riskLevel: '风险等级：中',
        dataAsOf: '数据截至 10:30',
        equityCurve: '权益曲线',
        ...
        activityThree: 'CTA 趋势跟踪触发回撤预警',
        strategyOverview: '策略概览',
        strategyDescription: '快速查看当前策略运行表现',
        manageStrategies: '管理策略',
