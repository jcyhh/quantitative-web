export const enUS = {
    ...
    layout: {
        environment: 'Paper trading environment',
        workspace: 'QUANTITATIVE WORKSPACE',
        marketConnected: 'Market data connection is healthy',
    ...
    dashboard: {
        greeting: 'Good morning, Jcy',
        subtitle: 'Here is an overview of your quantitative investment workspace.',
        createStrategy: '+ Create strategy',
        equity: 'Strategy equity',
        totalReturn: 'Total return',
        maxDrawdown: 'Maximum drawdown',
        activeStrategies: 'Active strategies',
        equityChange: 'Today +1.24%',
        returnChange: 'Last 30 days +3.18%',
        riskLevel: 'Risk level: Medium',
        dataAsOf: 'Data as of 10:30',
        ...
        activityThree: 'CTA Trend Following triggered a drawdown alert',
        strategyOverview: 'Strategy overview',
        strategyDescription: 'Quickly review current strategy performance',
    ...
    pages: {
        ...
        portfolio: {
            ...
            description: 'Track performance, risk exposure, and current positions.',
        },
