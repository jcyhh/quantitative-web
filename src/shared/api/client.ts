...
export class ApiClient {
    ...
    post<T>(path: string, body?: RequestOptions['body'], options?: Omit<RequestOptions, 'body'>): Promise<T> {
        return this.request<T>(path, this.withBody('POST', body, options))
    }
    put<T>(path: string, body?: RequestOptions['body'], options?: Omit<RequestOptions, 'body'>): Promise<T> {
        return this.request<T>(path, this.withBody('PUT', body, options))
    }
    patch<T>(path: string, body?: RequestOptions['body'], options?: Omit<RequestOptions, 'body'>): Promise<T> {
